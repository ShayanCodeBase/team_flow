...
import { invalidateMemberQueries } from "@/lib/query-invalidation";
  ...
  const handleSubmit = (e: { preventDefault: () => void }) => {
    ...
    mutate(inviteCode, {
      onSuccess: (data) => {
        ...
        invalidateMemberQueries(queryClient, data.workspaceId);
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                Hey there! You&apos;re invited to join a Team Flow workspace!
              </CardTitle>
              <CardDescription>
                Looks like you need to be logged into your Team Flow account to
                join this Workspace.
              </CardDescription>
            </CardHeader>
            <CardContent>
