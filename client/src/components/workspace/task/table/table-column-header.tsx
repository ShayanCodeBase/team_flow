...
export type TaskTableSortState = {
  sortBy: TaskTableSortField | null;
  sortOrder: TaskTableSortOrder | null;
  onSort: (column: TaskTableSortField) => void;
};

type DataTableServerColumnHeaderProps = {
  title: string;
  sortKey: TaskTableSortField;
